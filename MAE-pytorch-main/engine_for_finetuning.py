...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    if loss_scaler is None:
        ...
        optimizer.zero_grad()
    # (imgs, label, indexes, domain_label)
    for data_iter_step, (samples, targets, indexes, domain_label) in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
